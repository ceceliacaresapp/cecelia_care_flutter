...
class _VitalFormState extends State<VitalForm> {
  ...
  Map<String, String> get _currentVitalInfo =>
      _vitalTypes.firstWhere((vt) => vt['key'] == _selectedTypeKey,
  ...
  Future<void> _handleSaveVital() async {
    ...
    try {
      ...
      final payload = <String, dynamic>{
        ...
        'loggedBy': currentUser.displayName ?? currentUser.email ?? _l10n.formUnknownUser,
      ...
      if (widget.editingItem != null) {
        ...
        await journalService.addJournalEntry('vital', payload, currentUser.uid);
  ...
  Future<void> _handleDeleteVital() async {
    ...
    if (confirmed == true) {
      ...
      try {
        final journalService = context.read<JournalServiceProvider>();
        await journalService.deleteJournalEntry('vital', widget.editingItem!.firestoreId);
        _showSnackBar(_l10n.formSuccessVitalDeleted, Colors.green);
        Navigator.of(context).pop();
        widget.onClose?.call();
      } catch (e) {
        debugPrint('Error deleting vital: $e');
        _showSnackBar(_l10n.formErrorFailedToDeleteVital, Colors.red);
      } finally {
        if (mounted) setState(() => _isSaving = false);
      }
    }
        ...
        actions: [
          if (widget.editingItem != null)
            IconButton(
              ...
              tooltip: _l10n.formTooltipDeleteVital,
              onPressed: _isSaving ? null : _handleDeleteVital,
            ),
        ],
      ),
      body: Center(
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: _vitalTypes.map((vt) {
                      final isSelected = vt['key'] == _selectedTypeKey;
                      return GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                              color: isSelected ? AppTheme.primaryColor : _theme.dividerColor,
                              width: 1,
                            ),
                          ),
                          child: Text(
                  ...
                  Text(
                    _l10n.vitalFormLabelValueRequired(currentVitalDisplayInfo['unit']!),
                    style: _theme.textTheme.bodyLarge?.copyWith(fontWeight: FontWeight.bold),
                  ),
                  const SizedBox(height: 8),
                  TextFormField(
                    ...
                    decoration:
                        InputDecoration(hintText: currentVitalDisplayInfo['placeholder']),
                    ...
                    validator: (value) {
                      ...
                      if (_selectedTypeKey == 'BP') {
                        ...
                        if (double.tryParse(value.trim()) == null) {
                          return _l10n.vitalFormValidationValueNumeric;
                        }
                      }
                      return null;
                    },
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(hintText: _l10n.vitalFormHintNotes),
                    maxLines: 3,
                    minLines: 1,
                  ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Btn(
                        ...
                        onPressed: _isSaving ? null : _handleSaveVital,
                        padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 12),
                      ),
                    ],
                  ),
