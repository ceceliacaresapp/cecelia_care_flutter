...
class _MyAccountScreenState extends State<MyAccountScreen> {
  ...
  final TextEditingController _preferredPronounsController = TextEditingController();
  final TextEditingController _userGoalsController = TextEditingController();
  ...
  void _loadProfileData() {
    ...
    if (profile != null) {
      ...
      _sexualOrientationController.text = profile.sexualOrientation ?? '';
      _genderIdentityController.text = profile.genderIdentity ?? '';
      _preferredPronounsController.text = profile.preferredPronouns ?? '';
  ...
  Future<void> _handleSaveProfile() async {
    ...
    final newSexualOrientation = _sexualOrientationController.text.trim();
    final newGenderIdentity = _genderIdentityController.text.trim();
    final newPreferredPronouns = _preferredPronounsController.text.trim();
    ...
    if (_originalProfile != null &&
        ...
        newRelationship == (_originalProfile!.relationshipToElder ?? '') &&
        newSexualOrientation == (_originalProfile!.sexualOrientation ?? '') &&
        newGenderIdentity == (_originalProfile!.genderIdentity ?? '') &&
        newPreferredPronouns == (_originalProfile!.preferredPronouns ?? '') &&
        newUserGoals == (_originalProfile!.userGoals ?? '')) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          // --- I18N UPDATE ---
          // Replaced hardcoded string with a localization key.
    ...
    final Map<String, dynamic> updates = {
      ...
      'relationshipToElder': newRelationship.isNotEmpty ? newRelationship : null,
      'sexualOrientation': newSexualOrientation.isNotEmpty ? newSexualOrientation : null,
      'genderIdentity': newGenderIdentity.isNotEmpty ? newGenderIdentity : null,
      'preferredPronouns': newPreferredPronouns.isNotEmpty ? newPreferredPronouns : null,
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(l10n.settingsErrorUpdatingProfile(e.toString()))),
        );
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    if (userProfile != null && _originalProfile?.uid != userProfile.uid) {
      _loadProfileData();
    }
                    ...
                    child: Column(
                      ...
                      children: [
                        Center(
                          child: CircleAvatar(
                            radius: 48,
                            backgroundColor: AppTheme.primaryColor.withAlpha((255 * 0.2).round()),
                            backgroundImage: userProfile.avatarUrl != null && userProfile.avatarUrl!.isNotEmpty
                                ? NetworkImage(userProfile.avatarUrl!)
                                : null,
                            child: (userProfile.avatarUrl == null || userProfile.avatarUrl!.isEmpty) && userProfile.displayName.isNotEmpty
                                ? Text(
                                ...
                                : (userProfile.avatarUrl == null || userProfile.avatarUrl!.isEmpty) && userProfile.displayName.isEmpty
                                    ? const Icon(
                                        Icons.person,
                                        size: 48,
                                        color: AppTheme.primaryColor,
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(hintText: l10n.settingsHintDisplayName),
                          validator: (value) {
                            if (value == null || value.trim().isEmpty) {
                              return l10n.settingsDisplayNameCannotBeEmpty;
                            }
                            return null;
                          },
                        ),
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(hintText: l10n.settingsHintUserGoals),
                          maxLines: 3,
                        ),
                        const SizedBox(height: 24),
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(hintText: l10n.settingsHintRelationshipToElder),
                        ),
                        const SizedBox(height: 16),
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(hintText: l10n.settingsHintSexualOrientation),
                        ),
                        const SizedBox(height: 16),
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(hintText: l10n.settingsHintGenderIdentity),
                        ),
                        const SizedBox(height: 16),
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(hintText: l10n.settingsHintPreferredPronouns),
                        ),
                        const SizedBox(height: 24),
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: isLoading && userProfileProvider.userProfile == null ? null : _handleSaveProfile,
                            style: ElevatedButton.styleFrom(
                              backgroundColor: AppTheme.accentColor,
                              padding: const EdgeInsets.symmetric(vertical: 12),
                            ),
                            child: userProfileProvider.isLoading && userProfileProvider.userProfile != null
                                ? const SizedBox(
                                    width: 20,
                                    height: 20,
